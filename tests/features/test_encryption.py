...
def test_encrypt_regular_archive_remove_unencrypted(tmp_path):
    ...
    encrypt_existing_archive(copied_archive_path, encryption_keys, remove_unencrypted=True)
...
def test_encrypt_regular_archive_to_destination(tmp_path):
    ...
    encrypt_existing_archive(archive_path, encryption_keys, destination_path)
...
def test_encrypt_regular_archive_force_override_existing(tmp_path):
    ...
    encrypt_existing_archive(archive_path, encryption_keys, destination_path, force=True)
...
def test_encrypt_regular_file_to_destination(tmp_path):
    ...
    encrypt_existing_archive(archive_file, encryption_keys, destination_path)
...
def test_encrypt_archive_split_remove_unencrypted(tmp_path):
    ...
    expected_listing = [".part1.tar.lst", ".part1.tar.lz.md5", ".part1.md5", ".part1.tar.lz.gpg", ".part1.tar.lz.gpg.md5", ".part1.tar.md5",
                        ...
                        ".part3.tar.lst", ".part3.tar.lz.md5", ".part3.md5", ".part3.tar.lz.gpg", ".part3.tar.lz.gpg.md5", ".part3.tar.md5"]
...
def test_encrypt_archive_split_to_destination(tmp_path):
    ...
    # Test if all files exist
    expected_listing = [".part1.tar.lz.gpg", ".part1.tar.lz.gpg.md5", ".part2.tar.lz.gpg", ".part2.tar.lz.gpg.md5", ".part3.tar.lz.gpg", ".part3.tar.lz.gpg.md5"]
    ...
    # Test hashes
    assert valid_md5_hash_in_file(destination_path.joinpath(FOLDER_NAME + ".part1.tar.lz.gpg.md5"))
    assert valid_md5_hash_in_file(destination_path.joinpath(FOLDER_NAME + ".part2.tar.lz.gpg.md5"))
